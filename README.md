...
Список вважається однозв'язним, оскільки перехід можливий лише в одному напрямку: від поточного вузла до наступного. Останній вузол у списку завжди містить нульовий вказівник (nullptr), що сигналізує про кінець послідовності. Основні компоненти однозв’язного списку:
